...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-horizontal footer-center p-5 border-t-2 bg-[#0F0F0F]">
        <aside>
          <div className="flex items-center justify-center my-7">
            <img src="/lawlogo-removebg.png" className="w-15 h-15 bg-white rounded-xl" alt="" />
            <Link to={"/"} className="mx-5 text-white font-bold text-4xl">
             LawyerSpot
            </Link>
          </div>
          {/* links */}
          ...
          <div className="grid grid-flow-col gap-6">
            <a>
              <svg
                ...
                height="28"
                viewBox="0 0 24 24"
                className="fill-current text-blue-400 hover:text-blue-500"
              >
            ...
            <a>
              <svg
                ...
                height="30"
                viewBox="0 0 24 24"
                className="fill-current bg-blue-500  text-white hover:bg-blue-600 border rounded-full"
              >
